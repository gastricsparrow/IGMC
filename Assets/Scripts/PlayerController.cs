...
public class PlayerController : MonoBehaviour {
	...
	void CheckGround()
	{
		RaycastHit2D hit = Physics2D.Raycast(transform.position, Vector2.down, raycastLength, (1 << LayerMask.NameToLayer("Platform")) | (1 << LayerMask.NameToLayer("PhasableSolid")));
